...
namespace Pathfinding {
	...
	public partial class AIPath {
		 ...
		 * \deprecated When unifying the interfaces for different movement scripts, this property has been renamed to #targetReached (lowercase t)
		  */
		[System.Obsolete("When unifying the interfaces for different movement scripts, this property has been renamed to targetReached (lowercase t).  [AstarUpgradable: 'TargetReached' -> 'targetReached']")]
