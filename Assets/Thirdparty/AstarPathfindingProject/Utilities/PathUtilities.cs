...
namespace Pathfinding {
	...
	public static class PathUtilities {
		 ...
		 *
		 * \note If you are making changes to the graph without using e.g #AstarPath.UpdateGraph or the \link Pathfinding.GraphUpdateScene GraphUpdateScene\endlink component, areas must first be recaculated using AstarPath.FloodFill().
		 ...
		 *
		 * \note If you are making changes to the graph without using e.g #AstarPath.UpdateGraph or the \link Pathfinding.GraphUpdateScene GraphUpdateScene\endlink component, areas must first be recaculated using e.g AstarPath.FloodFill().
		 * \see \ref graph-updates
		 *
